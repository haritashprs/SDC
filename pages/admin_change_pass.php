...
<body>
    ...
    <main>
        ...
        <div class="container d-flex justify-content-center">
        <h2 class="text-danger">Get Your New Password</h2>
        </div>
        <br>
        ...
        <div class="container">
            <div class="container d-flex justify-content-center">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" value="" placeholder="OTP-"
                        required>
            ...
            <div class="container d-flex justify-content-center">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" value="" placeholder="XXXXXXXXXX"
                        required>
