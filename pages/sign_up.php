...
if(isset($_POST['submit']))
{
     ...
     $Pno=$_POST['username'];
     $Mno=$_POST['pass'];
     $Adrs=$_POST['c_password'];
     
     $sql ="INSERT INTO sign_up (mob_no,f_name,l_name,username,pass,c_password) 

     VALUES ('$Mob','$Fname','$Lname','$Pno','$Mno','$Adrs')";
...
<!------------------------------------------------------------------------------------------------------->
    ...
    <main>
        ...
        <div class="container d-flex justify-content-center">
            <h1 class="text-primary">Register Now</h1>
        </div>
        <br>
        <div class="container">
            <form class="row g-3" method="post" action="reg.php">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="mob_no" id="validationDefault01" value="" required>
                </div>
                <div class="col-md-4">
                    <label for="validationDefault01" class="form-label">First name</label>
                    <input type="text" class="form-control" name="f_name" id="validationDefault01" value="" required>
                </div>
                <div class="col-md-4">
                    <label for="validationDefault02" class="form-label">Last name</label>
                    <input type="text" class="form-control" name="l_name" id="validationDefault02" value="" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <label for="validationDefault04" class="form-label" >Confirmed password</label>
                    <!-- <select class="form-select" id="validationDefault04" required>
                       <option selected disabled value="">Choose...</option>
                        <option>...</option>
                    </select> -->
                    <input type="text" class="form-control" name="c_password" id="validationDefault03" required>
                </div>
            <!--    <div class="col-md-3">
                ...
                <div class="col-12 d-flex justify-content-center">
                    <a href="reg.php">
                    <button class="btn btn-primary" type="submit" name="submit" onclick="document.location='reg.php'">Sign Up</button>
                    </a>
                </div>
            </form>
        </div>
